...
export const planEpochRatePct = (plan: 0 | 1 | 2): number => {
  // Exact epoch rates per plan (showing 4 decimal places)
  switch (plan) {
    case 0: return 0.1267; // 400% APY - 0.1266823992070194
    case 1: return 0.1842; // 750% APY - 0.1841788094691376
    case 2: return 0.2413; // 1400% APY - 0.2413004638752772
    default: return 0;
  }
};
...
export const getPlanName = (plan: 0 | 1 | 2): string => {
  switch (plan) {
    case 0: return '400% APY';
    case 1: return '750% APY';
    case 2: return '1400% APY';
...
/**
 * Format an Ethereum address for display (alias for truncateAddress)
 * @param address - Full Ethereum address
